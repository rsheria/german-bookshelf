-- ABSOLUTE FINAL FIX - SIMPLIFIED VERSION
-- This script uses a much simpler approach to fix the entity_id type issue

-- ==========================================
-- STEP 1: RECREATE ACTIVITY_LOGS TABLE
-- ==========================================
...
-- Drop the table (this will remove any constraints)
...
-- ==========================================
-- STEP 3: FIX update_user_last_active FUNCTION
-- ==========================================
...
-- ==========================================
-- STEP 4: FIX get_online_users FUNCTION
-- ==========================================
...
-- ==========================================
-- STEP 5: ADD SIMPLE TEST SESSION TO VERIFY
-- ==========================================
